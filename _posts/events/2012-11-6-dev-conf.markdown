...
<h2 id="marcos">Marcos Galperin </h2>
...
<h2 id="daniel">Daniel Rabinovich </h2>
...
<h2 id="dario">Darío Simonassi &#38; Jonathan Leibiusky </h2>
...
<h2 id="rogeiro">Rogeiro Teixeira </h2>
...
<h2 id="wesley">Wesley Nascimento </h2>
...
<h2 id="stelleo">Stelleo Tolda</h2>
...
<h2 id="sole">Soledad Dematteo</h2>
...
<h2 id="helisson">Helisson Lemos</h2>
...
<h2 id="fersca">Fernando Scasserra</h2>
...
<ul>
	...
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('marcos')">Marcos Galperin</a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('daniel')">Daniel Rabinovich</a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('dario')">Darío Simonassi &#38; Jonathan Leibiusky </a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('rogeiro')">Rogeiro Teixeira </a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('pablo')">Pablo Moretti </a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('wesley')">Wesley Nascimento </a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('stelleo')">Stelleo Tolda </a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('sole')">Soledad Dematteo</a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('javier')">Javier Olivan</a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('helisson')">Helisson Lemos</a></li>
	<li class="option"><a href="javascript:void(0)" onClick="goToByScroll('fersca')">Fernando Scasserra</a></li>
